      ...
      <Tooltip.Root openDelay={333}>
        ...
        <Tooltip.Content>
          <p class="max-w-[300px] text-wrap">
            How likely customers are to continue to use, renew or buy again your product, based on inferred customer
    ...
    {:then}
      ...
      {:else}
        {@const metricRate = rate(
          (metric.intentions[entities.ReviewIntention.RETAIN] || 0) +
            (metric.intentions[entities.ReviewIntention.RETAIN_AND_RECOMMEND] || 0),
        ...
        {#if previousMetric}
          {@const previousMetricRate = rate(
            (previousMetric.intentions[entities.ReviewIntention.RETAIN] || 0) +
              (previousMetric.intentions[entities.ReviewIntention.RETAIN_AND_RECOMMEND] || 0),
